        ...
        <?php
            ...
            while ($row = pg_fetch_assoc($stmt3)) {
               ...
               // Check if $stock is null and set it to 0
                                  ...
                                  <td style="width: 15px;">
                                  <i class="fa fa-pencil-square-o checkbox-icon" id="icon-<?php echo $id2; ?>"></i>
                                  <input type="hidden" name="selected[]" class="single-checkbox" id="selected-<?php echo $id2; ?>" value="'.$item_code.'">

                                  <i class="fa fa-trash checkbox-icon2" id="icon-<?php echo $id2; ?>"></i>
                                  <input type="hidden" name="selected[]" class="single-checkbox3" id="selected-<?php echo $id2; ?>" value="'.$item_code.'">
                              </td>
