...
$maxTransactionNumberQuery = "SELECT MAX(transaction_number) AS max_transaction_number FROM tbl_mim_summary UNION SELECT MAX(transaction_number) AS max_transaction_number FROM tbl_mim_approvaltest";
