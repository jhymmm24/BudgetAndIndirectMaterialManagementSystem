                     ...
                     <div class="row column_title">
                        <div class="col-md-12">
                           <div class="page_title">
                              <h2 style="margin-top:20px;">Output Query and Modify</h2>
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="input-group mb-3">
                ...
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                    <span class="input-group-text"  style="width:150px; background-color:white; font-size:12px;"><span style="color:red;">*</span>Application Number</span>
                  </div>
...
<form>
        ...
        <thead>
            ...
            <th style="text-align: center;">Date Output</th>
        ...
        <tbody>
        <?php
               $selectcommon = "SELECT * FROM tbl_output";
            ...
            while ($row = pg_fetch_assoc($stmt3)) {
               ...
               echo '<tr>
               <td style="font-size: 12px; text-align: center;">' . $warehouse . '</td>
               <td style="font-size: 12px; text-align: center;">' . $output_type . '</td>
               <td style="font-size: 12px; text-align: center;">' . $application_number . '</td>
               <td style="font-size: 12px; text-align: center;">' . $output_date . '</td>
               ...
               <td style="font-size: 12px; text-align: center; ">' . $output_qty . '</td>
               <td style="font-size: 12px; text-align: center; ">' . $uom . '</td>
               <td style="font-size: 12px; text-align: center; ">' . $section . '</td>
               <td style="font-size: 12px; text-align: center; ">' . $cost_center . '</td>
               <td style="font-size: 12px; text-align: center; ">' . $purpose . '</td>
               <td style="font-size: 12px; text-align: center; ">' . $requestor . '</td>
               <td style="font-size: 12px; text-align: center; ">' . $remarks . '</td>
             </tr>';
...
?>
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="input-group mb-3">
      <button type="button" class="button-cus3" style="width:150px;"><i class="fa-solid fa-file" style="color:black;"></i> Export</button>
      </div>
    </div>
  </div>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    let table = new DataTable('#example24', {
      ...
      buttons: [
        {
          extend: 'excelHtml5',
          title: 'Output Query and Modify-' + datetoday, // Changed filename to 'trial'
          className: 'd-none',
          exportOptions: {
            columns: ':visible'
          }
