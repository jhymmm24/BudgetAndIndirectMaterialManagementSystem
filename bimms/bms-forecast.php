...
<button type="button"  data-toggle="modal" data-target="#myModalAddLIST"  name="btnaddlist" id="btnaddlist" onclick="return confirm_addlist()"  class="button-cus2" role="button" style="position: relative; width: 150px;  "    ><i class="fa-solid fa-plus" style="color:black; margin-right:10px;"aria-hidden="true"></i>
   ...
   <div class="col-md-4">
      <div class="input-group mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text"  style="width:150px; background-color:#7371A1; color:white;">Month</span>
        </div>
      
        <select class="form-control" id="select_cost_center" name="cost_center" style="background-color:#F2F2F2">
    ...
    <div class="col-md-4">
      <div class="input-group mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text"  style="width:150px; background-color:#7371A1; color:white;">Section</span>
        </div>
  ...
  <div class="row">
   <div class="col-md-4">
      <div class="input-group mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text"  style="width:150px; background-color:#7371A1; color:white;">Account Code</span>
        </div>
    ...
    <div class="col-md-4">
      <div class="input-group mb-3">
        <div class="input-group-prepend">
          <span class="input-group-text"  style="width:150px; background-color:#7371A1; color:white;">Cost Center</span>
        </div>
        ...
        <script>
          $(document).ready(function(){
              ...
              function handleAjaxRequest(selectedOption) {
                  ...
                  $.ajax({
                      url: 'display_table_forecast.php',
                      method: 'POST',
