...
$mail = new \PHPMailer\PHPMailer\PHPMailer();
				...
				$mail->Subject = '【SRMS】Request for 3rd Approval ['. $reqID .']';
				...
				<table style="font-family:arial, sans-serif; border-collapse: collapse; width:100%"><tr style="background-color:#dddddd;">
				  ...
				  <th style="border:1px solid #dddddd; text-align:left;padding:8px;">[MGR] Approved</th>
				...
				<td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$mgr_approved_by</td>
				<td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$mgr_approved_date</td>
			...
			$sql2 = "SELECT * FROM [dbo].[tbl_useraccounts] WHERE FullName = '$gmapprover' ";
        ...
        $mail = new \PHPMailer\PHPMailer\PHPMailer();
                ...
                $mail = new \PHPMailer\PHPMailer\PHPMailer();
                                ...
                                $body = '<p style="color:black; font-family:Arial; font-weight:bold;">Good day!</p>
                                <p style="color:black; font-family:Arial;">Request for 3rd Approval in SPRMS - PO Price Change has been submitted to you.</p>
                                <p style="color:black; font-family:Arial;">For more details, click the <a href="http://APBIPHBPSTS01:8080/SPRMS_Approval/forms/sessionchecker.php?control=mgr&reqID='.$reqID.'&reqCategory='.$reqCategory.'">SPRMS</a> and login your credentials.</p>
                                <table style="font-family:arial, sans-serif; border-collapse: collapse; width:100%"><tr style="background-color:#dddddd;">
                                  <th style="border:1px solid #dddddd; text-align:left;padding:8px;">Request Date</th>
                                  <th style="border:1px solid #dddddd; text-align:left;padding:8px;">[MGR] Approved</th>
...
<script> 
        window.location.replace("mgrapprovaltable.php");
 </script>
