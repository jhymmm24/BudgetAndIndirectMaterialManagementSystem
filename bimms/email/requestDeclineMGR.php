...
$mail = new \PHPMailer\PHPMailer\PHPMailer();
				...
				<table style="font-family:arial, sans-serif; border-collapse: collapse; width:100%"><tr style="background-color:#dddddd;">
				  ...
				  <th style="border:1px solid #dddddd; text-align:left;padding:8px;">[MGR] Declined By</th>
				  <th style="border:1px solid #dddddd; text-align:left;padding:8px;">Declined Date</th>
                    ...
                    <th style="border:1px solid #dddddd; text-align:left;padding:8px;">Reason of Declined</th>
					</tr>';
				$body .= "<tr>
				<td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$requestdate</td>
				<td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$mgrdeclinedby</td>
				<td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$mgrdeclinedate</td>
                ...
                <td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$reasonofdeclined</td>
