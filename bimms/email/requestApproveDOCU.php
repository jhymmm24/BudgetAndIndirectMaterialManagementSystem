...
while ($row = sqlsrv_fetch_array($results, SQLSRV_FETCH_ASSOC)) {
   ...
   $gm_approved_date = $row['DOCU_APPROVED_DATE'];
   $docu_approved_by = $row['DOCU_APPROVED_BY'];
   $docu_approved_date = $row['GM_APPROVED_DATE'];
...
$mail = new \PHPMailer\PHPMailer\PHPMailer();
				...
				$mail->Subject = '【SRMS】Request for 5th Approval ['. $reqID .']';
                ...
                <p style="color:black; font-family:Arial;">Request for 3rd Approval in SPRMS - Price Input Checklist has been submitted to you.</p>
				...
				<table style="font-family:arial, sans-serif; border-collapse: collapse; width:100%"><tr style="background-color:#dddddd;">
				  ...
				  <th style="border:1px solid #dddddd; text-align:left;padding:8px;">[DOCU] Approved</th>
...
$mail = new \PHPMailer\PHPMailer\PHPMailer();
				...
				$body = '<p style="color:black; font-family:Arial; font-weight:bold;">Good day!</p>
                <p style="color:black; font-family:Arial;">Request for 3rd Approval in SPRMS -  Quota Arrangement has been submitted to you.</p>
				<p style="color:black; font-family:Arial;">For more details, click the <a href="http://APBIPHBPSTS01:8080/SPRMS_Approval/forms/sessionchecker.php?control=mgr&reqID='.$reqID.'&reqCategory='.$reqCategory.'">SPRMS</a> and login your credentials.</p>
				<table style="font-family:arial, sans-serif; border-collapse: collapse; width:100%"><tr style="background-color:#dddddd;">
				  <th style="border:1px solid #dddddd; text-align:left;padding:8px;">Request Date</th>
				  <th style="border:1px solid #dddddd; text-align:left;padding:8px;">[DOCU] Approved</th>
...
$mail = new \PHPMailer\PHPMailer\PHPMailer();
				...
				$body = '<p style="color:black; font-family:Arial; font-weight:bold;">Good day!</p>
                <p style="color:black; font-family:Arial;">Request for 5th Approval in SPRMS -  PO Price Change has been submitted to you.</p>
				<p style="color:black; font-family:Arial;">For more details, click the <a href="http://APBIPHBPSTS01:8080/SPRMS_Approval/forms/sessionchecker.php?control=mgr&reqID='.$reqID.'&reqCategory='.$reqCategory.'">SPRMS</a> and login your credentials.</p>
				<table style="font-family:arial, sans-serif; border-collapse: collapse; width:100%"><tr style="background-color:#dddddd;">
				  <th style="border:1px solid #dddddd; text-align:left;padding:8px;">Request Date</th>
				  <th style="border:1px solid #dddddd; text-align:left;padding:8px;">[DOCU] Approved</th>
				...
				$body .= "<tr>
				<td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$requestdate</td>
				<td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$docu_approved_by</td>
				<td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$docu_approved_date</td>
				<td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$section</td>
				<td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$plant</td>
				<td style='border:1px solid #dddddd; text-align:left;padding:8px;'>$category</td>
...
<script> 
        window.location.replace("docuapprovaltable.php");
 </script>
